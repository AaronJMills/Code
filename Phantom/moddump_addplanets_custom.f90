...
subroutine modify_dump(npart,npartoftype,massoftype,xyzh,vxyzu)
 ...
 real    :: mplanet(maxplanets),rplanet(maxplanets),accrplanet(maxplanets),eccplanet(maxplanets) !added
...
! print*,'Mass of central star: ', star_m
 ...
 do i=1,nplanets
    ...
    call prompt('Enter initial eccentricity of planet '//trim(planets(i))//' :',eccplanet(i),0.) !added
 enddo
 ...
 do i=1,nplanets
    ...
    vxyz_ptmass(1:3,nptmass)    = (/-vphi*sinphi,vphi*(eccplanet(i)+cosphi),0./) !added
